...
namespace FSpot.Utils
{
	public static class GtkUtil
	{
		...
		public static Gtk.MenuItem MakeMenuItem (Gtk.Menu menu, string label, string imageName, EventHandler e, bool enabled)
		{
			Gtk.ImageMenuItem i = new Gtk.ImageMenuItem (label);
			i.Activated += e;
			i.Sensitive = enabled;
			i.Image = Gtk.Image.NewFromIconName (imageName, Gtk.IconSize.Menu);
		...
		{
			using var i = new Gtk.SeparatorMenuItem ();
			menu.Append (i);
			i.Show ();
		}
